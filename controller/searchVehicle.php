...
if ($conn) {
    ...
    $query = "SELECT V.V_id,V.Reg, V.engine, V.chassis, MK.makename, MD.modelname, C.categoryname, S.stationname, cs.name,date_of_maturity,dep_years
              FROM vehicles V
