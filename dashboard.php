...
<style>
.select2-container {
  z-index: 999900000000000000 !important;
}

.select2-dropdown {
  z-index: 105000000000000000 !important; /* Higher than Bootstrap modal */
  position: absolute !important; /* Ensure it overlays other elements */
}
                                ...
                                <div class="card-body">
                                    <form id="vehicleForm">
                                        <div class="row align-items-center">
                                            <label for="fromDate" class="cust-form-label col-lg-4 col-md-12">From</label>
                                    ...
                                    <div class="card mini-stats-wid">
                                        <div class="card-body text-end">
                                                ...
                                                <a href="issues.php" type="button" class="btn btn-primary waves-effect waves-light">
                                                    <i class="fas fa-exclamation-circle font-size-16 align-middle me-2"></i> Logs
                                                </a>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">Total Vehicle</p>
                                                            <h4 class="mb-0" id="ttlVehicle">00</h4>
                                                        </div>

                                                        <div class="flex-shrink-0 align-self-center">
                                                            <div class="mini-stat-icon avatar-sm rounded-circle ">
                                                                <span class="avatar-title">
                                                                    <i class="fa-solid fa-car font-size-24"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">MB</p>
                                                            <h4 class="mb-0" id="ttlMBVehicle">00</h4>
                                                        </div>

                                                        <div class="flex-shrink-0 align-self-center">
                                                            <div class="mini-stat-icon avatar-sm rounded-circle ">
                                                                <span class="avatar-title">
                                                                    <i class="fa-solid fa-motorcycle font-size-24"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">SCV</p>
                                                            <h4 class="mb-0" id="ttlSCVVehicle">00</h4>
                                                        </div>

                                                        <div class="flex-shrink-0 align-self-center">
                                                            <div class="mini-stat-icon avatar-sm rounded-circle ">
                                                                <span class="avatar-title">
                                                                    <i class="fa-solid fa-truck-field font-size-24"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">MCV</p>
                                                            <h4 class="mb-0" id="ttlMCVVehicle">00</h4>
                                                        </div>

                                                        <div class="flex-shrink-0 align-self-center">
                                                            <div class="mini-stat-icon avatar-sm rounded-circle ">
                                                                <span class="avatar-title">
                                                                    <i class="fa-solid fa-truck font-size-24"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-2">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">LCV</p>
                                                            <h4 class="mb-0" id="ttlLCVVehicle">00</h4>
                                                        </div>

                                                        <div class="flex-shrink-0 align-self-center">
                                                            <div class="mini-stat-icon avatar-sm rounded-circle ">
                                                                <span class="avatar-title">
                                                                    <i class="fa-solid fa-truck-moving font-size-24"></i>
                                                                </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">GOPS Drivers</p>
                                                            <h4 class="mb-0" id="drivercountGOPS">00</h4>
                                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-3">
                                            <div class="card mini-stats-wid">
                                                <div class="card-body">
                                                    <div class="d-flex">
                                                        <div class="flex-grow-1">
                                                            <p class="text-muted fw-medium">GTW Drivers</p>
                                                            <h4 class="mb-0" id="drivercountGTW">00</h4>
                                                        </div>
                        ...
                        <div class="modal-body">
                            <form id="addVehicleMaintenanceForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="addVMVehicleList" name="VehcileCategory[]" required>
                                    </select>
                                </div>
                                <div class="mb-3">
