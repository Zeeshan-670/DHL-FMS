  ...
  (e.prototype = {
    init: function () {
      (this.editing = !1),
        ...
        this.options.button &&
          a(this.options.buttonSelector, this.element).bind(
            'click',
    ...
    edit: function () {
      ...
      a('td[data-field]', this.element).each(function () {
        ...
        if (
          ((c[e] = f),
          a(this).empty(),
          b.options.maintainWidth && a(this).width(g),
          e in b.options.dropdowns)
        ) {
          d = a('<select></select>');
          for (var h = 0; h < b.options.dropdowns[e].length; h++)
            a('<option></option>').text(b.options.dropdowns[e][h]).appendTo(d);
          d.val(f).data('old-value', f).dblclick(b._captureEvent);
        } else d = a('<input type="text" />').val(f).data('old-value', f).dblclick(b._captureEvent);
        d.appendTo(this),
          b.options.keyboard && d.keydown(b._captureKey.bind(b));
      }),
    ...
    _captureKey: function (a) {
      13 === a.which
        ? ((this.editing = !1), this.save())
        : 27 === a.which && ((this.editing = !1), this.cancel());
    },
  }),
    (a.fn[f] = function (b) {
